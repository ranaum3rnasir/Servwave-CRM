// The one field set every scheduling surface renders: start date, start time, end date,
// end time. What is pinned here is that SHAPE and how each field moves the others - the
// arithmetic itself lives in scheduleTimeValue.test.
import { describe, it, expect, vi } from 'vitest';
import { screen, fireEvent } from '@testing-library/react';
import { renderWithProviders } from '@/__tests__/helpers';
import { ScheduleTimeFields } from './ScheduleTimeFields';
import type { ScheduleTimeValue } from './scheduleTimeValue';
