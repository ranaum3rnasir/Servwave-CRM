...
import { ChevronDown, Check, ArrowUp, ArrowDown, X, Search, Download, SlidersHorizontal } from 'lucide-react';
import { SelectField } from '@/components/form/SelectField';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';

/**
 * Shared building blocks for report pages: a multi-select dropdown filter,
 * a delta pill, an inline sparkline, and deterministic sample-data helpers
 * (so a given report always shows the same numbers across renders).
 */

// ── Deterministic PRNG (stable sample data keyed by report slug) ──────────────
