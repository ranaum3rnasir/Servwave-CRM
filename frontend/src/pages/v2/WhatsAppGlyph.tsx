/**
 * WhatsApp brand mark. Lucide ships no brand icons, and neither does the kit.
 *
 * Duplicated from the same glyph inside `components/layout/Header.tsx` rather
 * than lifted out of it: that file is a legacy page-chrome component this
 * migration must leave untouched, and exporting from it would edit it. The
 * duplication is one path with no logic, and it disappears when the legacy
 * header is deleted at cutover.
 */
