 ...
 * unit-testable and ported VERBATIM to the frontend sample-data path
 * (frontend/src/pages/reports/communication-tracking-logic.ts). Keep the two
 * files in LOCKSTEP — edit one, mirror the other.
 *
